      ...
      <main className="flex-1 pb-24 overflow-y-auto">
        ...
        {currentView === 'new-me' && (
          <div className="p-6 space-y-6 max-w-lg mx-auto pb-24">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-7 gap-2">
                  {Array.from({ length: 30 }, (_, i) => {
                    ...
                    const hasProgress = newMeProgress[day] && Object.values(newMeProgress[day]).filter(Boolean).length > 0;
                    ...
                    return (
                      ...
                      >
                        ...
                        {isToday && <span className="text-[8px] font-bold">{t.newMe.today}</span>}
                      </div>
                    );
                  })}
                </div>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-stone-600 dark:text-stone-400">{badge.desc}</p>
                          </div>
            ...
            {/* Suivi journalier - Check-list du jour */}
            <Card className={`border-none shadow-lg ${theme === 'dark' ? 'bg-stone-900' : 'bg-white'}`}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <CheckSquare className="w-5 h-5 text-purple-500" />
                  {t.newMe.dailyTracking} - {t.newMe.day} {newMeCurrentDay}
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
