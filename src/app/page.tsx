...
import { Sparkles, BookOpen, BookText, TrendingUp, Home, Heart, Target, Layers, Gift, Settings, ChevronRight, ChevronLeft, ChevronDown, Check, Plus, X, Minus, Calendar, Moon, Sun, Droplet, Zap, Smile, Activity, Utensils, Lightbulb, Wand2, Image as ImageIcon, Trash2, Download, Bell, BellOff, Star, CheckSquare, ListChecks, Award, Globe, LogIn, LogOut, User, Crown, Shield, Frown, Meh, HelpCircle, MoreHorizontal, Mail, Share2, ArrowRight, Eye, EyeOff, Flame, LayoutGrid, Palette, Trophy, Users } from 'lucide-react';
  ...
  */
  ...
  const gloweeHomepageMessages = {
    fr: [
      ...
      'Les défis d\'aujourd\'hui construisent la force de demain.',
      'Crois en toi, tout commence par là.',
      'Même les petits progrès sont des victoires.',
      ...
      'Tu as déjà surmonté tant de choses.',
      'Le succès commence par une décision courageuse.',
      'Ta détermination fera la différence.',
      'Les erreurs sont des leçons déguisées.',
      'Aujourd\'hui est une opportunité à saisir.',
      'Tu es capable de bien plus que tu ne l\'imagines.',
      'Garde confiance, tout évolue avec le temps.',
      'Ton énergie positive attire de belles choses.',
      ...
      'Sois patient(e) avec toi-même, le progrès prend du temps.',
      'Tu as en toi tout ce qu\'il faut pour réussir.',
      'Même dans le doute, tu avances.',
      'Ta force intérieure est plus grande que n\'importe quel obstacle.',
      'Les rêves deviennent réalité quand on ose y croire.',
    ...
    en: [
      ...
      'Believe in yourself, it all starts there.',
      'Even small progress is a victory.',
      ...
      'Success begins with a courageous decision.',
      'Your determination will make the difference.',
      'Mistakes are lessons in disguise.',
      'Today is an opportunity to seize.',
      'You are capable of much more than you imagine.',
      'Keep faith, everything evolves with time.',
      'Your positive energy attracts beautiful things.',
      ...
      'Even in doubt, you move forward.',
      'Your inner strength is greater than any obstacle.',
      'Dreams become reality when you dare to believe.',
    ...
    es: [
      ...
      'Los desafíos de hoy construyen la fuerza de mañana.',
      'Cree en ti mismo, todo empieza ahí.',
      'Incluso los pequeños avances son victorias.',
      ...
      'Ya has superado tantas cosas.',
      'El éxito comienza con una decisión valiente.',
      'Tu determinación marcará la diferencia.',
      'Los errores son lecciones disfrazadas.',
      'Hoy es una oportunidad por aprovechar.',
      'Eres capaz de mucho más de lo que imaginas.',
      'Mantén la confianza, todo evoluciona con el tiempo.',
      'Tu energía positiva atrae cosas hermosas.',
      'Continúa, estás en el camino correcto.',
      ...
      'Tu perseverancia terminará dando frutos.',
      'Nunca es tarde para empezar de nuevo.',
      'Ten paciencia contigo mismo, el progreso toma tiempo.',
      'Tienes todo lo necesario para triunfar dentro de ti.',
      'Incluso en la duda, avanzas.',
      'Tu fuerza interior es mayor que cualquier obstáculo.',
      'Los sueños se hacen realidad cuando te atreves a creer.',
  ...
  // Ces pages sont sautées - l'utilisateur va directement au dashboard après presentation-3
