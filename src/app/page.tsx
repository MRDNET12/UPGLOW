                          ...
                          return (
                            <div key={win.id || index} className="relative flex items-start gap-4">
                              ...
                              <div className="relative z-10 flex-shrink-0 ml-1">
                                <div className={`w-14 h-14 rounded-full flex items-center justify-center shadow-lg ${isMilestone
                              ...
                              <div className="flex-1 pt-2">
                                <div className={`rounded-2xl p-5 shadow-md ${isMilestone
              ...
              <DrawerContent className="bg-white">
                ...
                <div className="px-4 pb-6 space-y-3">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-4 rounded-2xl border-2 transition-all ${prideJournalDesign === 'gallery'
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-4 rounded-2xl border-2 transition-all ${prideJournalDesign === 'timeline'
                        ? 'border-pink-500 bg-pink-50'
                        : 'border-gray-200 hover:border-pink-200'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-4 p-4 rounded-2xl border-2 transition-all ${prideJournalDesign === 'celebrate'
                        ? 'border-pink-500 bg-pink-50'
                        : 'border-gray-200 hover:border-pink-200'
                      }`}
                  >
      ...
      <Drawer open={showAddMenu} onOpenChange={setShowAddMenu}>
        <DrawerContent className="max-w-lg mx-auto bg-white">
          ...
          <div className="p-6 space-y-6">
            ...
            {/* Section Mes Habitudes - Visible uniquement sur la page Habitudes */}
            {currentView === 'trackers' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="font-bold text-gray-800 text-lg">
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-gray-100">
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-2xl border-2 border-gray-200 focus:border-emerald-400 focus:outline-none text-gray-700 placeholder-gray-400 bg-white text-sm"
                      onKeyDown={(e) => {
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
                  >
                    <Plus className="w-5 h-5 text-white" />
                  </button>
                </div>
