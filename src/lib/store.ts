...
export type View = 'language-selection' | 'presentation' | 'onboarding' | 'dashboard' | 'challenge' | 'journal' | 'trackers' | 'routine' | 'vision-board' | 'bonus' | 'new-me' | 'glowee-chat' | 'settings';
